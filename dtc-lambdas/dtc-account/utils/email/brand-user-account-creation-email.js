                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="">
                    ...
                    <tr>
                        <td style="padding: 20px 15px 20px 15px;font-size: 14px;color: rgb(35, 35, 35); line-height: 18px;">
                          You've been invited by {{companay_name}} to have {{role_name}} access. To accept please navigate to dtc.parkstreet.com and login using email and temporary password that can be found below. To decline simply ignore this email.
                        </td>
                    </tr>
                    <tr>
