/**
 * @name SavedTemplates Model
 * @desc Brand wise saved templates not published
 * @author Innovify
 */
const db = require('dynamoose');

const SavedTemplates = new db.Schema({
    brand_id: {
        type: String,
        trim: true,
        required: true,
...
module.exports = db.model('Saved_templates', SavedTemplates, options);
