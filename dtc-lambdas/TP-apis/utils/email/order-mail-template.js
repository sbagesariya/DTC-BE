        ...
        <tr>
            <td style="padding: 20px 0 30px 0;">
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="">
                           ...
                           <table style="width: 100%;">
                               <tr>
                                   ...
                                   <td style="width:50%; border-radius: 6px;border: 1px solid rgb(151, 151, 151); font-size: 14px; line-height: 26px; border:1px solid #dee2e6; padding: 15px;">
                                        ...
                                        <span style="color: rgb(139, 14, 4); font-size: 14px;">Fullfilled By: </span>{{fulfilledBy}}
                                    </td>
                               </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 5px 0px 15px 15px;font-size: 14px;color: rgb(35, 35, 35); line-height: 20px;">
                            {{emailBody.row_1}}
                        </td>
                    </tr>
                    {{#if emailBody.row_2}}
                    <tr>
                        <td style="padding: 5px 15px 20px 15px;font-size: 14px;color: rgb(35, 35, 35); line-height: 20px;">
                        {{emailBody.row_2}}
                        </td>
                    </tr>
                    {{/if}}
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-radius: 6px;padding: 20px;border: 1px solid #c4c4c4;">
                               <tr>
                                   <td style="width: 50%; vertical-align: top;">
                                      ...
                                      {{#each product_detail}}`;
html += `<tr>
                                            <td style="background-color: #d8d8d8; width: 80px; height: 88px;"></td>
...
html += `<tr>
                    ...
                    {{#if footerData}}
                      ...
                      <tr>
                        <td style="padding-bottom: 15px;color: rgb(139, 14, 4);font-size: 14px;font-weight: bold;height: 14px;line-height: 22px;text-align: center;">
                          <span>{{footerData.row_2}}</span>
                        </td>
                      </tr>
                    {{/if}}
                    <tr>
