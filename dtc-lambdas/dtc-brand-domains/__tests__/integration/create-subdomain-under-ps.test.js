...
const lambda = require('./../../src/handlers/create-subdomain-under-ps');
...
const mockData = [
    ...
    {
        'title': 'Should able to create subdomain under ps',
        'data': {
            'brand_id': '9b9af5d1-d518-4441-9c98-9a477241ab91',
            'domain_name': 'stgdtc.parkstreet.com',
            'brand_name': 'brand-1'
...
describe('Test createSubDomainUnderPSHandler', () => {
    let getSpy;
    let amplifySpy;
    beforeAll(() => {
    ...
    mockData.forEach(ele => {
        it(ele.title, async () => {
            ...
            const result = await lambda.createSubDomainUnderPSHandler(event);
