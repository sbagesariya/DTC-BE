...
const lambda = require('./../../src/handlers/get-domain-association');
...
const mockData = [
    ...
    {
        'title': 'Should able to get domain association',
        'data': {
            'brand_id': '9b9af5d1-d518-4441-9c98-9a477241ab91',
            'domain_name': 'm12.com'
        },
...
describe('Test getDomainAssociationHandler', () => {
    let getSpy;
    let amplifySpy;
    beforeAll(() => {
    ...
    mockData.forEach(ele => {
        it(ele.title, async () => {
            ...
            const result = await lambda.getDomainAssociationHandler(event);
