...
const lambda = require('../../src/handlers/get-fulfillment-settings');
...
const mockData = [
    ...
    {
        'title': 'Get brand fulfillment details',
        'data': {
...
describe('Test AddProductAndMarket', () => {
    ...
    mockData.forEach(ele => {
        it(ele.title, async () => {
            ...
            const result = await lambda.GetFulfillmentSettingsHandler(event);
